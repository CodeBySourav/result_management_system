                                    ...
                                    <div class="col-md-12">
                                        <div class="panel">
                                            ...
                                            <div class="panel-body">
                                                ...
                                                <form class="form-horizontal" action="createstudentsubjectphp.php" method="post">
                                                    
													<div class="form-group">
                                                        <label for="default" class="col-sm-2 control-label">sl_no</label>
                                                        <div class="col-sm-10">
 <input type="text" name="sl_no" class="form-control" id="default" placeholder="sl_no" required="required">
                                                        </div>
                                                    </div>
													...
													<div class="form-group">
                                                        ...
                                                        <div class="col-sm-10">
 <input type="text" name="subject_name" class="form-control" id="default" placeholder="Subject Name" required="required">
                                                        </div>
                                                    </div>
<div class="form-group">
