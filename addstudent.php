                                    ...
                                    <div class="col-md-12">
                                        <div class="panel">
                                            ...
                                            <div class="panel-body">
                                                ...
                                                <form class="form-horizontal" method="post" action="addstudentphp.php">
...
<div class="col-sm-10">
<input type="text" name="class" class="form-control" id="default"  required="required" >
</div>
</div>
...
<div class="col-sm-10">
<input type="text" name="section" class="form-control" id="default"  required="required" >
</div>
</div>
